...
// Populates the given DS list with the IDs of instances of the given object colliding within the given ellipse.
// It optionally orders them by distance from the center of the ellipse and returns the number of instances found to be in collision.
...
if (ordered)
{
    // Setup priority and ellipse center:
    var priority, cx, cy;
    ...
    with (obj)
    {
        if (!notme || id != other.id)
        {
            ...
            if (!collision_ellipse(x1, y1, x2, y2, id, prec, false)) continue;
