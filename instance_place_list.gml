...
// Populates the given DS list with the IDs of instances of the given object which would collide with the current instance using its collision mask at the given position.
...
if (ordered)
{
    ...
    with (obj)
    {
        ...
        if (!instance_place(xx, yy, id)) continue;
